...
void swap1(int& n1, int& n2) //added ampersand for swap function for ints n1 and n2
{
  int temp = n1;
  n1 = n2;
  n2 = temp;
...
void swap4(int* &p1, int* &p2) //swap the address of p1 and p2
{
  int* temp = p1;
  p1 = p2;
  p2 = temp;
...
int main()
{
  ...
  int* p1 = &num1; //p1 has the address of an int.
  int* p2 = &num2; //p1 has the address of an int.
